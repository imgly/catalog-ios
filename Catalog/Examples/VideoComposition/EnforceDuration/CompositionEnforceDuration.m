...
@interface CompositionEnforceDurationObjC () <PESDKVideoEditViewControllerDelegate>

@end

@implementation CompositionEnforceDurationObjC
...
- (void)invokeExample {
   ...
   PESDKConfiguration *configuration = [[PESDKConfiguration alloc] initWithBuilder:^(PESDKConfigurationBuilder * _Nonnull builder) {
     ...
     [builder configureVideoEditViewController:^(PESDKVideoEditViewControllerOptionsBuilder * _Nonnull options) {
       ...
       options.forceTrimMode = PESDKForceTrimModeIfNeeded;
     }];
   }];
